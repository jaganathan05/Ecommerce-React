...
function AboutPage (){
    ...
    return <div>
        ...
        <div className="container bg-success form-control" ><h1 className="text-center ">Jack Store</h1></div>
        
        <h3 className="about-heading text-center">About Us</h3>
        ...
        <div className="container bg-warning form-control" ><h1 className="">Jack Store</h1></div>
      </div>
        </div>
